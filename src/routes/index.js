...
const homeRoutes = { id: "클러스터",  path: "/", icon: <Icon.Home/>, containsHome: true, component: Cluster, children: null };
...
// 인증 라우트
const authRoutes = {id: "auth", path: "/auth", icon: <Users/>, children: [
...
const analysisRoutes = [
    {header: "분석", id: "사전", path: "/analysis/dictionary", icon: <Icon.Visibility/>, component: Dictionary, children: null},
